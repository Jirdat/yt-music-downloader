...
st.markdown("""<button ><a href="https://www.instagram.com/jirdat_timung?igsh=MWFlaG15Y2t4Zjlyaw==" style='text-decoration: none; color: white; font-size: 10px;'>Follow Us</a></button>""", unsafe_allow_html=True)
